package experiments.databaseprototype;
...
import experiments.databaseprototype.Notes.*;
import experiments.databaseprototype.Users.*;
...
public class DatabaseprototypeApplication {

	public static void main(String[] args) {
		SpringApplication.run(DatabaseprototypeApplication.class, args);
	}
	@Bean

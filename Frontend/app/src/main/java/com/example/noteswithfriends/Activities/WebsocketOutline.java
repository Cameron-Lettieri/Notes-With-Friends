...
public class WebsocketOutline extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_websocket_outline);
    ...
    private void connectWebSocket() {
        ...
        try {
             ...
             */
            uri = new URI("ws://coms-309-064.cs.iastate.edu:8080/message/" + HomeScreen.user.getID());
